...
class bilaxy (Exchange):
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        response = await self.privateGetTradeView(self.extend(request, params))
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if since is not None:
            request['since'] = since
        response = await self.privateGetTradeList(self.extend(request, params))
        return self.parse_orders(response['data'], market, since, limit)

    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        openParams = {'type': 1}  # 1 => Pending orders
        return await self.fetch_orders(symbol, since, limit, self.extend(openParams, params))
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        order = await self.privateGetTradeView({'id': response['data']})
    ...
    async def fetch_deposit_address(self, code, params={}):
        ...
        response = await self.privateGetCoinAddress(self.extend(request, params))
